...
class ChangeCinemaDialog(QtWidgets.QDialog):

    def __init__(self, listOfCities, previousStreet, previousCity,  *args, **kwargs):
        super(ChangeCinemaDialog, self).__init__(*args, **kwargs)
        self.setFixedHeight(225)
        self.setFixedWidth(400)
        self.setWindowTitle('Изменение кинотеатра')
        ...
        self.lineEdit = QtWidgets.QLineEdit(previousStreet)
        ...
        for i in range(len(listOfCities)):
            ...
            if previousCity == listOfCities[i][0]:
                self.listOfCities.setCurrentText(listOfCities[i][1])
