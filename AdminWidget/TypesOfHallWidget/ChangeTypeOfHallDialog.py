...
class ChangeTypeOfHallDialog(QtWidgets.QDialog):

    def __init__(self, type, countOfRows, countOfColumns, *args, **kwargs):
        super(ChangeTypeOfHallDialog, self).__init__(*args, **kwargs)
        self.setFixedHeight(225)
        self.setFixedWidth(400)
        self.setWindowTitle('Измменение типа зала')
